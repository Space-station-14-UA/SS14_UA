...
laws-ui-menu-title = Закони силіконів
laws-ui-law-header = Закон {$id}
laws-ui-select-all = Вибрати всі
laws-ui-select-all-tooltip = Це вибере ВСІ закони, включно з тими, які, ймовірно, мають залишатися в таємниці.
laws-ui-select-none = Зняти виділення
laws-ui-state-law = Оголосити вибрані закони
...
laws-window-footer-left = Пам'ятайте: ви повинні бути послідовними у тлумаченні своїх законів!
laws-window-footer-right = Версія {$version}
