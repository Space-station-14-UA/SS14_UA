...
ui-options-max-fps-display-rate = Частота оновлення екрана
ui-options-max-fps-tooltip = Максимальна частота кадрів клієнта. Встановіть 0 для зняття обмеження. Не діє, якщо увімкнено VSync.
